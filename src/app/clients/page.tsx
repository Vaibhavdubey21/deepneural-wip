    ...
    <div>
            ...
            {[
              {
                ...
                description: "Leveraging GenAI to streamline recruitment processes, reducing time-to-hire by 60% and improving candidate quality through intelligent matching algorithms.",
                image: "/AI.jpg"
              },
              {
                ...
                industry: "Healthcare",
                description: "Revolutionizing dental imaging with AI-powered diagnostics that detect issues with 98% accuracy, helping dentists provide better care and reduce misdiagnosis.",
                image: "/meditech.jpg"
              },
              {
                ...
                description: "Implementing AI agents to monitor production lines, resulting in 35% reduction in defects, 22% increase in throughput, and significant energy savings.",
              ...
              <AnimatedCard key={index} delay={0.1 * index} className="overflow-hidden">
                ...
                <div className="p-6">
                  <div className="flex items-center mb-2">
                    <span className="text-sm font-medium text-primary-dark">{study.industry}</span>
                  </div>
                  <h3 className="text-xl font-bold mb-2">{study.title}</h3>
                  <p className="text-gray-600 mb-4">{study.description}</p>
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium">{study.company}</span>
                    <Link href="/contact-us" className="text-primary hover:text-primary-dark flex items-center text-sm font-medium">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
            {[
              ...
              {
                quote: "Working with DeepNeural has been a game-changer for our dental practice. Their AI imaging platform has significantly improved our diagnostic accuracy.",
                author: "Dr. Michael Chen",
                position: "Founder, 4EDental.com",
                rating: 5
              },
              {
                quote: "The manufacturing optimization solution provided by DeepNeural exceeded our expectations. We've seen dramatic improvements in efficiency and quality.",
                author: "Robert Patel",
      ...
      <section className="py-20 bg-dark text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold font-display mb-6">Ready to transform your business with AI?</h2>
