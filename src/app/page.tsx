...
import { ArrowRight, Brain, Cpu, Database, LineChart, Zap, Users, Shield } from 'lucide-react';
    ...
    <div className="overflow-hidden">
      ...
      <section className="relative bg-dark pt-32 pb-20 md:pt-40 md:pb-32 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 opacity-30">
          <div className="absolute inset-0 bg-gradient-to-r from-blue-600 via-purple-600 to-blue-600 mix-blend-multiply"></div>
          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="md:w-1/2">
              ...
              >
                ...
                <div className="absolute -top-4 -right-4 -bottom-4 -left-4 bg-primary/30 rounded-2xl -z-10 blur-2xl animate-pulse-slow"></div>
                
                {/* Enhanced floating elements */}
                <motion.div 
                  className="absolute -top-6 -left-6 bg-dark-lighter p-3 rounded-2xl shadow-lg border border-primary/30 backdrop-blur-md"
                  animate={{ y: [0, -10, 0] }}
                ...
                <motion.div 
                  className="absolute -bottom-6 -right-6 bg-dark-lighter p-3 rounded-2xl shadow-lg border border-secondary/30 backdrop-blur-md"
                  animate={{ y: [0, 10, 0] }}
                ...
                <motion.div 
                  className="absolute top-1/2 -right-12 bg-dark-lighter p-3 rounded-2xl shadow-lg border border-white/30 backdrop-blur-md hidden md:block"
                  animate={{ x: [0, 10, 0] }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Seamlessly connect to your existing data sources and knowledge bases to leverage institutional knowledge."
              },
              {
                icon: <Zap size={40} className="text-primary" />,
                title: "Real-time Processing",
                description: "Process and respond to data streams in real-time, enabling immediate action and adaptation."
              },
              {
                icon: <Users size={40} className="text-primary" />,
                title: "Human-like Interaction",
                description: "Natural language capabilities that make interaction with AI agents intuitive and productive for all users."
              },
              {
                icon: <LineChart size={40} className="text-primary" />,
                title: "Predictive Analytics",
                description: "Forecast trends, identify opportunities, and mitigate risks before they impact your business."
              },
              {
                icon: <Shield size={40} className="text-primary" />,
                title: "Enterprise Security",
                description: "Built with security-first architecture ensuring your data and operations remain protected."
              }
            ].map((feature, index) => (
              <AnimatedCard 
                key={index} 
            ...
            {[
              {
                ...
                description: "Reduced fraud detection time by 90% while improving accuracy to 99.7% using our autonomous monitoring agents.",
                image: "/agents.jpg",
                tag: "Finance"
              },
              {
                ...
                description: "Diagnostic accuracy improved by 35% with our AI agents assisting medical professionals in image analysis and patient data interpretation.",
                image: "/meditech.jpg",
                tag: "Healthcare"
              },
              {
                ...
                description: "Predictive maintenance agents reduced downtime by 78% and extended equipment lifespan by 40% across production facilities.",
              ...
              >
                ...
                <div className="p-6 border-t border-gray-100">
                  ...
                  >
                    Read Case Study <ArrowRight size={16} className="ml-1 transition-all" />
                  </Link>
                </div>
              </AnimatedCard>
            ))}
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <motion.p 
              ...
              transition={{ duration: 0.5, delay: 0.2 }}
            >
              Join the AI revolution and stay ahead of the competition with our cutting-edge autonomous agents.
            </motion.p>
