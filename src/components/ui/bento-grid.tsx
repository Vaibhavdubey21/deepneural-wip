...
const BentoGrid = ({ children, className, ...props }: BentoGridProps) => {
  return (
    <div
      className={cn(
        'grid w-full gap-3 grid-cols-1 auto-rows-auto lg:grid-cols-2 lg:auto-rows-[6rem]',
        className
      )}
      {...props}
    >
...
const BentoCard = ({
  ...
  >
    <Badge
      variant="secondary"
      className={cn(
        'absolute py-1.5 px-2.5 rounded-full top-3 right-3 z-50 text-white group-hover:scale-105 transition-all duration-300 flex items-center justify-center gap-1',
        badgeClass
      )}
    >
