...
import { motion, AnimatePresence, useReducedMotion, LayoutGroup, type Variants } from "framer-motion";
               ...
               >
                 ...
                 >
                   <img
                     src={card.image}
                     alt={card.title}
                     className="w-full h-full object-contain transform-gpu group-hover:scale-105 transition-transform duration-700 ease-out"
                   />
                   {card.gradientColors && (
                     <div className={`absolute inset-x-0 bottom-0 h-1/5 bg-gradient-to-t ${card.gradientColors[0]} ${card.gradientColors[1]} to-transparent opacity-60`}></div>
                   )}

                   {/* Category and time info */}
                   <motion.div
                     className="absolute bottom-3 left-3 text-white bg-black/50 backdrop-blur-sm rounded-md px-2.5 py-1.5"
                 ...
                 <div className="h-full overflow-y-auto">
                   ...
                   >
                     ...
                     {selectedCard.gradientColors && (
                       <div className={`absolute inset-x-0 bottom-0 h-1/3 bg-gradient-to-t ${selectedCard.gradientColors[0]} ${selectedCard.gradientColors[1]} to-transparent opacity-60`}></div>
                     )}

                     {/* Image overlay info */}
                     <div className="absolute bottom-4 left-4 text-white bg-black/50 backdrop-blur-sm rounded-md px-3 py-2">
