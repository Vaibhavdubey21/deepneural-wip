...
const cardVariants = cva('absolute will-change-transform', {
  variants: {
    variant: {
      dark: 'flex size-full flex-col items-center justify-center gap-6 rounded-2xl border border-slate-700 bg-zinc-900/90 p-6 backdrop-blur-md',
      light:
        'flex size-full flex-col items-center justify-center gap-6 rounded-2xl border border-gray-200 bg-white/90 p-6 backdrop-blur-md',
    },
  },
  defaultVariants: {
    variant: 'light',
...
>(
  (
    ...
    const cardStyle = {
      ...
      filter: variant === 'dark' ? 'none' : dropShadow,
      ...style,
    };
